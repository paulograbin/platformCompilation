                ...
                <div class="account-section-content">
                    ...
                    <div class="account-overview-table">
                        <table class="responsive-table">
                            <caption content="text.company.manageUser.pageAll"></caption>
                            <tr class="responsive-table-head hidden-xs">
                                <th scope="col"><spring:theme code="text.company.column.name.name"/></th>
                                <th scope="col"><spring:theme code="text.company.column.roles.name"/></th>
                                <th scope="col"><spring:theme code="text.company.manageUser.user.costCenter"/></th>
                                <th scope="col"><spring:theme code="text.company.column.parentUnit.name"/></th>
                                <th scope="col"><spring:theme code="text.company.status.title"/></th>
                            </tr>
