...
public class CPQReorderController extends AbstractController
{
	...
	/**
	 * Accepts HTTP-PUT requests and delegates to {@link CPQReorderController#reorder(String, RedirectAttributes)}
	 */
	@RequestMapping(value = "/cpqreorder", method = RequestMethod.PUT)
	@RequireHardLogIn
	public String reorderPUT(@RequestParam(value = "orderCode") final String orderCode, final RedirectAttributes redirectModel)
			throws CommerceCartModificationException
	{
		return reorder(orderCode, redirectModel);
	}

	/**
	 * Accepts HTTP-POST requests and delegates to {@link CPQReorderController#reorder(String, RedirectAttributes)}
	 */
	@RequestMapping(value = "/cpqreorder", method = RequestMethod.POST)
	@RequireHardLogIn
	public String reorderPOST(@RequestParam(value = "orderCode") final String orderCode, final RedirectAttributes redirectModel)
			throws CommerceCartModificationException
	{
		return reorder(orderCode, redirectModel);
	}
	 ...
	 * @throws CommerceCartModificationException
	 */
	protected String reorder(final String orderCode, final RedirectAttributes redirectModel)
			throws CommerceCartModificationException
	{
