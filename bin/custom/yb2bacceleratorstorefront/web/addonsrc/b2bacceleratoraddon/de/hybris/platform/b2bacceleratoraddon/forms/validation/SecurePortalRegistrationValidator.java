...
public class SecurePortalRegistrationValidator implements Validator
{
	...
	public void validate(final Object object, final Errors errors)
	{
		...
		if(registrationForm.isOtpForRegistrationEnabled())
		{
			final String verificationTokenCode = registrationForm.getVerificationTokenCode();
			validateBlankText(errors, verificationTokenCode, "verificationTokenCode");
		}
	}
