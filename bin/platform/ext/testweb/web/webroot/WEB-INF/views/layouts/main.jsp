...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/static/js/jquery-3.7.1.min.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/static/js/jquery-ui/jquery-ui.min.js" />"></script>
