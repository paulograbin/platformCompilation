...
public class DisableLoginForImportedUserInterceptorIntegrationTest extends ServicelayerBaseTest
{
	...
	private static final String userPassword = RandomStringUtils.randomAlphanumeric(16);
	private static final String impexPassword = RandomStringUtils.randomAlphanumeric(16);
	private static final Object[][] DECISION_TABLE = new Object[][]{
			...
			testCase(7, null, null, impexPassword, null, false),
			testCase(8, null, null, impexPassword, false, false),
			testCase(9, null, null, impexPassword, true, true),
			...
			testCase(16, "", false, impexPassword, null, false),
			testCase(17, "", false, impexPassword, false, false),
			testCase(18, "", false, impexPassword, true, true),
			...
			testCase(25, "", true, impexPassword, null, true),
			testCase(26, "", true, impexPassword, false, false),
			testCase(27, "", true, impexPassword, true, true),
			testCase(28, userPassword, false, null, null, false),
			testCase(29, userPassword, false, null, false, false),
			testCase(30, userPassword, false, null, true, true),
			testCase(31, userPassword, false, "", null, true),
			testCase(32, userPassword, false, "", false, true),
			testCase(33, userPassword, false, "", true, true),
			testCase(34, userPassword, false, impexPassword, null, false),
			testCase(35, userPassword, false, impexPassword, false, false),
			testCase(36, userPassword, false, impexPassword, true, true),
			testCase(37, userPassword, true, null, null, true),
			testCase(38, userPassword, true, null, false, false),
			testCase(39, userPassword, true, null, true, true),
			testCase(40, userPassword, true, "", null, true),
			testCase(41, userPassword, true, "", false, true),
			testCase(42, userPassword, true, "", true, true),
			testCase(43, userPassword, true, impexPassword, null, true),
			testCase(44, userPassword, true, impexPassword, false, false),
			testCase(45, userPassword, true, impexPassword, true, true)
	};
	...
	@Test
	public void shouldFollowDecisionTableForAllPasswordEncoding()
	{
		for (final String passwordEncoding : PasswordEncoderTestUtils.NON_DEPRECATED_ENCODINGS)
		{
			LOGGER.info("Password encoding:{}", passwordEncoding);
			assertThatAllImpExRelevantTestCasesSucceeded(CustomerModel.class, false, passwordEncoding);
		}
	}
	...
	{
		assertThatAllImpExRelevantTestCasesSucceeded(userClass, distributedImpEx, null);
	}

	private void assertThatAllImpExRelevantTestCasesSucceeded(final Class<? extends UserModel> userClass,
	                                                          final boolean distributedImpEx, final String passwordEncoding)
	{
		for (final Object[] testCase : DECISION_TABLE)
		{
			assertThatTestCaseSucceeded(userClass, testCase, false, distributedImpEx, passwordEncoding);
		}
	}
	...
	{
		assertThatTestCaseSucceeded(userClass, testCase, useUserRights, distributedImpEx, null);
	}
	                                         ...
	                                         final String passwordEncoding)
	{
		...
		try
		{
			...
			final String uid = givenUniqueUID();
			givenUser(userClass, testCase, uid, passwordEncoding);
	                       ...
	                       final String passwordEncoding)
	{
		...
		{
			user.setPasswordEncoding(passwordEncoding);
		}
