...
public class ProcessImpexTaskTest extends ServicelayerBaseTest
{
	...
	{
		// given
		final String ahertzPassword = RandomStringUtils.randomAlphanumeric(16);
		final String abrodePassword = RandomStringUtils.randomAlphanumeric(16);
		final String importData = "INSERT_UPDATE Customer;uid[unique=true];customerID;name;password\n" //
				+ ";ahertz;K2006-C0005;Anja Hertz;" + ahertzPassword + "\n" //
				+ ";abrode;K2006-C0006;Arin Brode;" + abrodePassword + "\n";
		final TestImportBatchHandler handler = new TestImportBatchHandler(importData);
		...
		assertEquals(ahertz, authenticationService.checkCredentials("ahertz", ahertzPassword));
		assertEquals(abrode, authenticationService.checkCredentials("abrode", abrodePassword));
	}
