...
public class LocalizedValidationMessagesIntegrationTest extends ServicelayerTransactionalBaseTest
{
	...
	@Test
	public void shouldReturnProperMessageForNotExistingComposedTypeValidation()
	{
		// given
		i18NService.setCurrentLocale(Locale.ENGLISH);
		final TestPojo pojo = new TestPojo(null);
		...
		assertThat(violations.iterator().next().getLocalizedMessage()).isEqualTo("The attribute \"value\" must not be null.");
	}
