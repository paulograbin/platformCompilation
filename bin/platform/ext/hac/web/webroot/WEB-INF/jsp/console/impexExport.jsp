...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/webjars/codemirror/lib/codemirror.css"/>" type="text/css"
	...
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/lib/codemirror.js"/>"></script>
	...
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/addon/hint/show-hint.js"/>"></script>
		...
		<div class="marginLeft">
			...
			<div id="tabsNoSidebar">
				...
				<div id="tabs-1">
					...
					<form:form id="contentForm" method="post" action="${contentExportUrl}" data-validateUrl="${contentValidateUrl}" modelAttribute="impexExportContent">
				...
				<div id="tabs-2">
					...
					<form:form method="post" action="${fileExportUrl}" modelAttribute="impexExportFile" enctype="multipart/form-data">
						<fieldset>
							<legend>
					...
					<c:choose>
						<c:when test="${ exportResult.success eq true }">
							...
							<div id="downloadExportResultData" class="marginBottom box">
								<spring:message code="console.impex.result.export.download"></spring:message>:
								<ul>
									<li>
										<spring:message code="console.impex.result.export.dataDownloadUrl"></spring:message>: <a href="${exportResult.dataDownloadUrl}">${exportResult.exportDataName}</a>
									</li>
									<li>
										<spring:message code="console.impex.result.export.mediaDownloadUrl"></spring:message>: <a href="${exportResult.mediaDownloadUrl}">${exportResult.exportMediaName}</a>
									</li>
								</ul>
							</div>
						</c:when>
	...
	<div class="span-6 last" id="sidebar">
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<div class="quiet">
					<ul>
			 	   	<li> <a href="${wikiImpex}" target="_blank" rel="noopener noreferrer" class="quiet">ImpEx</a> </li>
					</ul>
				</div>
			</div>
		</div>
