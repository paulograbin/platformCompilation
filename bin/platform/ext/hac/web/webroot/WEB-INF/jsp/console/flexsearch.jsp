...
<link rel="stylesheet" href="<c:url value="/webjars/codemirror/lib/codemirror.css"/>" type="text/css" media="screen, projection
" />
...
<script type="text/javascript" src="<c:url value="/webjars/codemirror/mode/sql/sql.js"/>"></script>
