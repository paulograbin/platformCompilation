...
<head>
	...
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/mode/groovy/groovy.js"/>"></script>
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/mode/javascript/javascript.js"/>"></script>
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/mode/clike/clike.js"/>"></script>
	<script type="text/javascript" src="<c:url value="/webjars/codemirror/addon/selection/active-line.js"/>"></script>
				...
				<div class="box">
					<div class="quiet">
					 This page provides the Scripting Languages console. It comes with implicit variables:<br><br>
						...
						<strong>Output</strong> tab: Displays a string if the script uses a method to display text. The implicit variable <strong>out</strong> is available and is of <strong>PrintStream</strong> type.<br><br>
