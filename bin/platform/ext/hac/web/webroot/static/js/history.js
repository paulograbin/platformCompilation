...
hac.history.getHistory = function() {
	...
	if (history == null) {
		hac.global.saveToLocalStorage('history', hac.history.getDefaultHistory());
...
hac.history.getDefaultHistory = function () {
    if (typeof defaultHistory === 'undefined') {
        console.debug("defaultHistory is undefined");
        return {}
    } else {
