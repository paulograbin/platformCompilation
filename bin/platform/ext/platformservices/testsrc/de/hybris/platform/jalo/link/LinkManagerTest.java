...
public class LinkManagerTest extends ServicelayerBaseTest
{
	...
	private static final int FINISH_THREADS_WAIT_SECONDS = 100;
	...
	public void readLinkedItemsOldWay() throws Exception
	{
		...
		assertTrue("Not all workers finished after " + FINISH_THREADS_WAIT_SECONDS + " seconds.", holder.waitAndDestroy(
				FINISH_THREADS_WAIT_SECONDS));
