...
public class ItemModelCloneCreatorTest extends ServicelayerTest
{
	...
	public void copyItemTest()
	{
		...
		orderEntry.setGiveAway(Boolean.TRUE);
		...
		Assert.assertEquals(order.getNet(), orderClone.getNet());
		...
		Assert.assertEquals(order.getEntries().get(0).getGiveAway(), orderClone.getEntries().get(0).getGiveAway());
	...
	public void copyItemChangeTypeTest()
	{
		...
		Assert.assertEquals(cart.getNet(), orderClone.getNet());
		...
		Assert.assertEquals(cart.getEntries().get(0).getGiveAway(), orderClone.getEntries().get(0).getGiveAway());
