...
public class MediaFilterTest
{
	...
	public void shouldServeMediaFileAsStreamWhenRequestingNormalResourceWithDecodedLocationInContext() throws Exception
	{
		// given
		given(httpRequest.getParameter("context")).willReturn(
				"bWFzdGVyfHJvb3R8MTIzNDV8aW1hZ2UvanBlZ3xoMDEvaDAyL2Zvby5qcGd8cXdlcnR5MTIzNDU");  //master|root|12345|image/jpeg|h01/h02/foo.jpg|qwerty12345
		given(httpRequest.getServletPath()).willReturn("/realFilename.jpg");
		setUpMocksBehaviorForStandardMediaResource();
	...
	{
		// given
		given(httpRequest.getServletPath()).willReturn("/real!#Filename.xls");
		setUpMocksBehaviorForStandardMediaResource();

		// when (mediaFilter:369)
		mediaFilter.doFilter(httpRequest, httpResponse, chain);
