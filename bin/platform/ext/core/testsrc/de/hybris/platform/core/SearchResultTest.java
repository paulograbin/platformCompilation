...
public class SearchResultTest extends HybrisJUnit4Test
{
	...
	public void testResultsBeingCached()
	{
		...
		Assert.assertEquals("master", resFirst.getDataSourceId());
		...
		Assert.assertEquals("master", resNotCached.getDataSourceId());
	...
	public void testResults()
	{
		...
		Assert.assertEquals("master", result.getDataSourceId());
	...
	static class NonWrappingFlexibleSearch extends FlexibleSearch
	{
		...
		@Override
		protected SearchResult wrapSearchResult(final SearchResult cachedSearchResult, final boolean lazy) throws Exception
		{
			return cachedSearchResult;
		}
	}
