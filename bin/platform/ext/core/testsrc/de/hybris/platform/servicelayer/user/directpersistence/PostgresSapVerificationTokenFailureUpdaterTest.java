...
@UnitTest
public class PostgresSapVerificationTokenFailureUpdaterTest
{
	...
	private PostgresSapVerificationTokenFailureUpdater updater;

	@Before
	public void setUp()
	{
		jdbcTemplate = mock(JdbcTemplate.class);
		updater = new PostgresSapVerificationTokenFailureUpdater(jdbcTemplate, TABLE_NAME, FAILED_ATTEMPTS_COLUMN);
	}
