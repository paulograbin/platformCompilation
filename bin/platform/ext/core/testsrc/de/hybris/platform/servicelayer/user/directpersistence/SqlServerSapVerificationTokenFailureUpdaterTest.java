...
@UnitTest
public class SqlServerSapVerificationTokenFailureUpdaterTest
{
	...
	private SqlServerSapVerificationTokenFailureUpdater updater;

	@Before
	public void setUp()
	{
		jdbcTemplate = mock(JdbcTemplate.class);
		updater = new SqlServerSapVerificationTokenFailureUpdater(jdbcTemplate, TABLE_NAME, FAILED_ATTEMPTS_COLUMN);
	}
	...
	{
		PK verificationTokenPk = PK.fromLong(12345L);
		when(jdbcTemplate.query(anyString(), ArgumentMatchers.<RowMapper<Integer>>any(), anyLong())).thenThrow(
