...
import de.hybris.bootstrap.ddl.sql.DefaultExtendedParamsForIndex;
...
public class DbModelAdjusterTest
{
	...
	private Index createIndex(final String indexName, final Pair<String[], String[]> params, final boolean unique)
	{
		...
		final DefaultExtendedParamsForIndex extendedParamsForIndex = new DefaultExtendedParamsForIndex();
