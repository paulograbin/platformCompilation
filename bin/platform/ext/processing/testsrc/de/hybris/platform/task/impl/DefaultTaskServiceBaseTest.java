...
public abstract class DefaultTaskServiceBaseTest extends ServicelayerBaseTest
{
	...
	static class SpyTasksProvider implements TasksProvider
	{
		...
		@Override
		public void refreshState(final RuntimeConfigHolder runtimeConfigHolder, final TaskEngineParameters taskEngineParameters)
		{
			taskProvider.refreshState(runtimeConfigHolder, taskEngineParameters);
		}
