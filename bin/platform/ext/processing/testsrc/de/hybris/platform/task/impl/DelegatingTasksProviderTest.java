...
public class DelegatingTasksProviderTest
{
	...
	{
		final RuntimeConfigHolder runtimeConfigHolder = mock(MockRuntimeConfigHolder.class);
		final DefaultTaskService.TaskEngineRunningState taskEngineRunningState = spy(new MockTaskEngineRunningState());
	...
	public void testRefreshState()
	{
		...
		delegatingTasksProvider.refreshState(runtimeConfigHolder, taskEngineParameters);

		verify(tasksProvider).refreshState(runtimeConfigHolder, taskEngineParameters);
	}
