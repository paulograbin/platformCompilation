...
public class AuxiliaryTablesBasedTaskProviderTest
{
	...
	@Mock
	AuxiliaryTablesWorkerRole auxiliaryTablesWorkerRole;
	...
	@Test
	public void shouldRegisterAsWorkerWhenRefreshState()
	{
		auxiliaryTablesBasedTaskProvider.refreshState(runtimeConfigHolder, taskEngineParameters);

		verify(auxiliaryTablesWorkerRole).registerAsWorker(taskEngineParameters, runtimeConfigHolder);
	}
