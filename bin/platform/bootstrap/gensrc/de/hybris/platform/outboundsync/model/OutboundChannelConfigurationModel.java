...
public class OutboundChannelConfigurationModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>OutboundChannelConfiguration.batch</code> attribute defined at extension <code>outboundsync</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>OutboundChannelConfiguration.batch</code> attribute defined at extension <code>outboundsync</code>. 
	 * @return the batch - Flag to determine if outbound sync changes are sent as a batch request or as multiple requests.
	 */
	@Accessor(qualifier = "batch", type = Accessor.Type.GETTER)
	public Boolean getBatch()
	{
		return getPersistenceContext().getPropertyValue(BATCH);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>OutboundChannelConfiguration.batch</code> attribute defined at extension <code>outboundsync</code>. 
	 *  
	 * @param value the batch - Flag to determine if outbound sync changes are sent as a batch request or as multiple requests.
	 */
	@Accessor(qualifier = "batch", type = Accessor.Type.SETTER)
	public void setBatch(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(BATCH, value);
	}
