 ...
 */
@Schema(name="ComponentTypeData", description="Specifies properties of the component type.")
...
@Schema(name="type", example="SearchBoxComponent") 	
	private String type;
