 ...
 */
@Schema(name="AbstractPageData", description="Specifies properties of the page.")
...
@Schema(name="pk", example="8796093056052") 	
	private String pk;
...
@Schema(name="typeCode", example="ContentPage") 	
...
@Schema(name="template", example="LandingPageTemplate") 	
...
@Schema(name="defaultPage", example="true") 	
...
@Schema(name="onlyOneRestrictionMustApply", example="false") 	
