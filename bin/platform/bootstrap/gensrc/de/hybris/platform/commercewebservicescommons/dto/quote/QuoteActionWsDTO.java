 ...
 */
@Schema(name="QuoteAction", description="Action for the quote.")
...
@Schema(name="action", description="User's actions with the quote. Typical actions are: CANCEL, SUBMIT, ACCEPT, APPROVE, REJECT.", required=true, example="SUBMIT") 	
