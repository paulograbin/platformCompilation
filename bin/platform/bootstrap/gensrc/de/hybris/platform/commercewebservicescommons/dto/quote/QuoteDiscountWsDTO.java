 ...
 */
@Schema(name="QuoteDiscount", description="Discount applied to the quote")
...
@Schema(name="discountType", description="Type of the discount - PERCENT for discount by percentage, ABSOLUTE for discount by amount, TARGET for discount by adjustment of the total value", required=false, example="PERCENT") 	
...
@Schema(name="discountRate", description="Value of the discount", required=false, example="10") 	
