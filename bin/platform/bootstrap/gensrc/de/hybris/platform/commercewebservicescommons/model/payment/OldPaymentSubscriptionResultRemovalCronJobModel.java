...
public class OldPaymentSubscriptionResultRemovalCronJobModel extends CronJobModel
{
	 ...
	 * @return the age - After specified number of seconds payment subscription result will be cleaned up. Default is 24
	 * 						hour.
	 */
	 ...
	 *  
	 * @param value the age - After specified number of seconds payment subscription result will be cleaned up. Default is 24
	 * 						hour.
	 */
