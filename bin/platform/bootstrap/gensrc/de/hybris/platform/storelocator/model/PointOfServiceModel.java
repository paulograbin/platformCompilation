...
public class PointOfServiceModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>PointOfService.pickUpInStoreInstructions</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String PICKUPINSTOREINSTRUCTIONS = "pickUpInStoreInstructions";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PointOfService.pickUpInStoreInstructions</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the pickUpInStoreInstructions - Pick up in store instructions.
	 */
	@Accessor(qualifier = "pickUpInStoreInstructions", type = Accessor.Type.GETTER)
	public String getPickUpInStoreInstructions()
	{
		return getPickUpInStoreInstructions(null);
	}
	/**
	 * <i>Generated method</i> - Getter of the <code>PointOfService.pickUpInStoreInstructions</code> attribute defined at extension <code>commerceservices</code>. 
	 ...
	 */
	@Accessor(qualifier = "pickUpInStoreInstructions", type = Accessor.Type.GETTER)
	public String getPickUpInStoreInstructions(final Locale loc)
	{
		return getPersistenceContext().getLocalizedValue(PICKUPINSTOREINSTRUCTIONS, loc);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PointOfService.pickUpInStoreInstructions</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the pickUpInStoreInstructions - Pick up in store instructions.
	 */
	@Accessor(qualifier = "pickUpInStoreInstructions", type = Accessor.Type.SETTER)
	public void setPickUpInStoreInstructions(final String value)
	{
		setPickUpInStoreInstructions(value,null);
	}
	/**
	 * <i>Generated method</i> - Setter of <code>PointOfService.pickUpInStoreInstructions</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 ...
	 */
	@Accessor(qualifier = "pickUpInStoreInstructions", type = Accessor.Type.SETTER)
	public void setPickUpInStoreInstructions(final String value, final Locale loc)
	{
		getPersistenceContext().setLocalizedValue(PICKUPINSTOREINSTRUCTIONS, loc, value);
	}
