...
public class ConsignmentEntryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ConsignmentEntry.sapInvoice</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String SAPINVOICE = "sapInvoice";
	...
	/** <i>Generated constant</i> - Attribute key of <code>ConsignmentEntry.sourceOrderEntry</code> attribute defined at extension <code>warehousing</code>. */
	public static final String SOURCEORDERENTRY = "sourceOrderEntry";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ConsignmentEntry.sapInvoice</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the sapInvoice
	 */
	@Accessor(qualifier = "sapInvoice", type = Accessor.Type.GETTER)
	public SAPInvoiceModel getSapInvoice()
	{
		return getPersistenceContext().getPropertyValue(SAPINVOICE);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ConsignmentEntry.sourceOrderEntry</code> attribute defined at extension <code>warehousing</code>. 
	 * @return the sourceOrderEntry - Stores the order entries when performing the cancellation of an order
	 */
	@Accessor(qualifier = "sourceOrderEntry", type = Accessor.Type.GETTER)
	public OrderEntryModel getSourceOrderEntry()
	{
		return getPersistenceContext().getPropertyValue(SOURCEORDERENTRY);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ConsignmentEntry.sapInvoice</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the sapInvoice
	 */
	@Accessor(qualifier = "sapInvoice", type = Accessor.Type.SETTER)
	public void setSapInvoice(final SAPInvoiceModel value)
	{
		getPersistenceContext().setPropertyValue(SAPINVOICE, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ConsignmentEntry.sourceOrderEntry</code> attribute defined at extension <code>warehousing</code>. 
	 *  
	 * @param value the sourceOrderEntry - Stores the order entries when performing the cancellation of an order
	 */
	@Accessor(qualifier = "sourceOrderEntry", type = Accessor.Type.SETTER)
	public void setSourceOrderEntry(final OrderEntryModel value)
	{
		getPersistenceContext().setPropertyValue(SOURCEORDERENTRY, value);
	}
