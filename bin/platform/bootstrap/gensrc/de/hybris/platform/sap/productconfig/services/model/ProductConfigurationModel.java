...
public class ProductConfigurationModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ProductConfiguration.originalVariantProduct</code> attribute defined at extension <code>sapproductconfigservices</code>. */
	public static final String ORIGINALVARIANTPRODUCT = "originalVariantProduct";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ProductConfiguration.originalVariantProduct</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 * @return the originalVariantProduct - Product code of original variant in case base product has replaced variant in cart.
	 */
	@Accessor(qualifier = "originalVariantProduct", type = Accessor.Type.GETTER)
	public ProductModel getOriginalVariantProduct()
	{
		return getPersistenceContext().getPropertyValue(ORIGINALVARIANTPRODUCT);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ProductConfiguration.originalVariantProduct</code> attribute defined at extension <code>sapproductconfigservices</code>. 
	 *  
	 * @param value the originalVariantProduct - Product code of original variant in case base product has replaced variant in cart.
	 */
	@Accessor(qualifier = "originalVariantProduct", type = Accessor.Type.SETTER)
	public void setOriginalVariantProduct(final ProductModel value)
	{
		getPersistenceContext().setPropertyValue(ORIGINALVARIANTPRODUCT, value);
	}
