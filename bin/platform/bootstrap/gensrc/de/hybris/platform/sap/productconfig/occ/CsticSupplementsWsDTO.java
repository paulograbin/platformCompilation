 ...
 */
@Schema(name="CCPAttributePricing", description="Enriches an attribute with supplementary pricing data.")
...
@Schema(name="csticUiKey", description="Attribute key.", example="1-CONF_LAPTOP.AUDIO-ACCESSORY") 	
...
@Schema(name="selectedValues", description="List of currently selected domain values.") 	
...
@Schema(name="priceSupplements", description="List of value price supplements.") 	
