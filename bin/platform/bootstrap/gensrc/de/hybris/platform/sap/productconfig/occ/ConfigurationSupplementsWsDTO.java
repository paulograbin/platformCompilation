 ...
 */
@Schema(name="CCPConfigurationPricing", description="Enriches a product configuration with supplementary pricing data.")
...
@Schema(name="showDeltaPrices", description="Indicates that attribute surcharges are displayed relatively to the current attribute price.", example="true") 	
...
@Schema(name="pricingError", description="Indicates that pricing is currently not available.", example="false") 	
...
@Schema(name="attributes", description="List of supplementary data on attribute level.") 	
...
@Schema(name="priceSummary", description="Price summary.") 	
