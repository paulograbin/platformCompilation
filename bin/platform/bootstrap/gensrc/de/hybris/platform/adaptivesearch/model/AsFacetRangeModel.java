...
public class AsFacetRangeModel extends AbstractAsItemConfigurationModel
{
	...
	public AsFacetRangeModel(final AbstractAsFacetConfigurationModel _facetConfiguration, final String _id, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsFacetRangeModel(final CatalogVersionModel _catalogVersion, final AbstractAsFacetConfigurationModel _facetConfiguration, final String _id, final ItemModel _owner, final String _uid)
	{
		super();
