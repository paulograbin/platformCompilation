...
public class AbstractAsBoostItemConfigurationModel extends AbstractAsItemConfigurationModel
{
	...
	public AbstractAsBoostItemConfigurationModel(final ItemModel _item, final String _uid)
	{
		super();
		setItem(_item);
		setUid(_uid);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AbstractAsBoostItemConfigurationModel(final CatalogVersionModel _catalogVersion, final ItemModel _item, final ItemModel _owner, final String _uid)
	{
		super();
