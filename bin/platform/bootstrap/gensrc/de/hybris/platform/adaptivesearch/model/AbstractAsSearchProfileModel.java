...
public class AbstractAsSearchProfileModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractAsSearchProfile.queryContext</code> attribute defined at extension <code>adaptivesearch</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractAsSearchProfile.queryContext</code> attribute defined at extension <code>adaptivesearch</code>. 
	 * @return the queryContext
	 */
	@Accessor(qualifier = "queryContext", type = Accessor.Type.GETTER)
	public String getQueryContext()
	{
		return getPersistenceContext().getPropertyValue(QUERYCONTEXT);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractAsSearchProfile.queryContext</code> attribute defined at extension <code>adaptivesearch</code>. 
	 *  
	 * @param value the queryContext
	 */
	@Accessor(qualifier = "queryContext", type = Accessor.Type.SETTER)
	public void setQueryContext(final String value)
	{
		getPersistenceContext().setPropertyValue(QUERYCONTEXT, value);
	}
