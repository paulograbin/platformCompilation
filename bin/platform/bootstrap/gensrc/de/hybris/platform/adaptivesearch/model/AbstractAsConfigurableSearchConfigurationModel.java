...
public class AbstractAsConfigurableSearchConfigurationModel extends AbstractAsSearchConfigurationModel
{
	...
	public AbstractAsConfigurableSearchConfigurationModel(final String _uid)
	{
		super();
		setUid(_uid);
	}
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AbstractAsConfigurableSearchConfigurationModel(final CatalogVersionModel _catalogVersion, final ItemModel _owner, final String _uid)
	{
		super();
