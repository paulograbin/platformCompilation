...
public class AsExcludedSortModel extends AbstractAsSortConfigurationModel
{
	...
	public AsExcludedSortModel(final String _code, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid)
	{
		super();
		setCode(_code);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsExcludedSortModel(final CatalogVersionModel _catalogVersion, final String _code, final ItemModel _owner, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid)
	{
		super();
