...
public class AsExcludedItemModel extends AbstractAsBoostItemConfigurationModel
{
	...
	public AsExcludedItemModel(final ItemModel _item, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid)
	{
		super();
		setItem(_item);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsExcludedItemModel(final CatalogVersionModel _catalogVersion, final ItemModel _item, final ItemModel _owner, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid)
	{
		super();
