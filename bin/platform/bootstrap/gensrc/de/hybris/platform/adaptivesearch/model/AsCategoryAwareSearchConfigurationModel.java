...
public class AsCategoryAwareSearchConfigurationModel extends AbstractAsConfigurableSearchConfigurationModel
{
	...
	public AsCategoryAwareSearchConfigurationModel(final AsCategoryAwareSearchProfileModel _searchProfile, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsCategoryAwareSearchConfigurationModel(final CatalogVersionModel _catalogVersion, final CategoryModel _category, final ItemModel _owner, final AsCategoryAwareSearchProfileModel _searchProfile, final String _uid)
	{
		super();
