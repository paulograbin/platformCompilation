...
public class AsSortExpressionModel extends AbstractAsItemConfigurationModel
{
	...
	public AsSortExpressionModel(final String _expression, final AbstractAsSortConfigurationModel _sortConfiguration, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsSortExpressionModel(final CatalogVersionModel _catalogVersion, final String _expression, final ItemModel _owner, final AbstractAsSortConfigurationModel _sortConfiguration, final String _uid)
	{
		super();
