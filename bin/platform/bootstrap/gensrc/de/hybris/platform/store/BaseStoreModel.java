...
public class BaseStoreModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.captchaCheckEnabled</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String CAPTCHACHECKENABLED = "captchaCheckEnabled";
	
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.sapInvoiceEnabled</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String SAPINVOICEENABLED = "sapInvoiceEnabled";
	
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.requestedRetrievalDateEnabled</code> attribute defined at extension <code>commerceservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.captchaCheckEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.requestedRetrievalDateEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the requestedRetrievalDateEnabled - Enable/disable requested retrieval date feature
	 */
	@Accessor(qualifier = "requestedRetrievalDateEnabled", type = Accessor.Type.GETTER)
	public Boolean getRequestedRetrievalDateEnabled()
	{
		return getPersistenceContext().getPropertyValue(REQUESTEDRETRIEVALDATEENABLED);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.sapInvoiceEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the sapInvoiceEnabled - Determines whether the site should use order invoice.
	 */
	@Accessor(qualifier = "sapInvoiceEnabled", type = Accessor.Type.GETTER)
	public boolean isSapInvoiceEnabled()
	{
		return toPrimitive((Boolean)getPersistenceContext().getPropertyValue(SAPINVOICEENABLED));
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.captchaCheckEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.requestedRetrievalDateEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the requestedRetrievalDateEnabled - Enable/disable requested retrieval date feature
	 */
	@Accessor(qualifier = "requestedRetrievalDateEnabled", type = Accessor.Type.SETTER)
	public void setRequestedRetrievalDateEnabled(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(REQUESTEDRETRIEVALDATEENABLED, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.sapInvoiceEnabled</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the sapInvoiceEnabled - Determines whether the site should use order invoice.
	 */
	@Accessor(qualifier = "sapInvoiceEnabled", type = Accessor.Type.SETTER)
	public void setSapInvoiceEnabled(final boolean value)
	{
		getPersistenceContext().setPropertyValue(SAPINVOICEENABLED, toObject(value));
	}
