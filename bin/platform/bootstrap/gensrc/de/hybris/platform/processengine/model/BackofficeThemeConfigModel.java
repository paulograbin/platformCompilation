...
public class BackofficeThemeConfigModel extends AbstractDynamicContentModel
{
	 ...
	 */
	public BackofficeThemeConfigModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public BackofficeThemeConfigModel(final String _code, final String _content)
	{
		super();
		setCode(_code);
		setContent(_content);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public BackofficeThemeConfigModel(final String _code, final String _content, final ItemModel _owner)
	{
		super();
		setCode(_code);
		setContent(_content);
