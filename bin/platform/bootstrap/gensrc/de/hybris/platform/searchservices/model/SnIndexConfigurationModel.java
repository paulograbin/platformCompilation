...
import de.hybris.platform.searchservices.model.SnIndexerConfigurationModel;
...
public class SnIndexConfigurationModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>SnIndexConfiguration.localizationFallbackEnabled</code> attribute defined at extension <code>searchservices</code>. */
	public static final String LOCALIZATIONFALLBACKENABLED = "localizationFallbackEnabled";
	...
	/** <i>Generated constant</i> - Attribute key of <code>SnIndexConfiguration.indexerConfiguration</code> attribute defined at extension <code>searchservices</code>. */
	public static final String INDEXERCONFIGURATION = "indexerConfiguration";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SnIndexConfiguration.indexerConfiguration</code> attribute defined at extension <code>searchservices</code>. 
	 * @return the indexerConfiguration
	 */
	@Accessor(qualifier = "indexerConfiguration", type = Accessor.Type.GETTER)
	public SnIndexerConfigurationModel getIndexerConfiguration()
	{
		return getPersistenceContext().getPropertyValue(INDEXERCONFIGURATION);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SnIndexConfiguration.localizationFallbackEnabled</code> attribute defined at extension <code>searchservices</code>. 
	 * @return the localizationFallbackEnabled
	 */
	@Accessor(qualifier = "localizationFallbackEnabled", type = Accessor.Type.GETTER)
	public Boolean getLocalizationFallbackEnabled()
	{
		return getPersistenceContext().getPropertyValue(LOCALIZATIONFALLBACKENABLED);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>SnIndexConfiguration.indexerConfiguration</code> attribute defined at extension <code>searchservices</code>. 
	 *  
	 * @param value the indexerConfiguration
	 */
	@Accessor(qualifier = "indexerConfiguration", type = Accessor.Type.SETTER)
	public void setIndexerConfiguration(final SnIndexerConfigurationModel value)
	{
		getPersistenceContext().setPropertyValue(INDEXERCONFIGURATION, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>SnIndexConfiguration.localizationFallbackEnabled</code> attribute defined at extension <code>searchservices</code>. 
	 *  
	 * @param value the localizationFallbackEnabled
	 */
	@Accessor(qualifier = "localizationFallbackEnabled", type = Accessor.Type.SETTER)
	public void setLocalizationFallbackEnabled(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(LOCALIZATIONFALLBACKENABLED, value);
	}
