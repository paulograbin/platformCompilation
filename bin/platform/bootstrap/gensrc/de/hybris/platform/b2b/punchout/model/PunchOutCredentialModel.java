...
public class PunchOutCredentialModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>PunchOutCredential.sharedSecretModifiedTime</code> attribute defined at extension <code>b2bpunchout</code>. */
	public static final String SHAREDSECRETMODIFIEDTIME = "sharedSecretModifiedTime";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PunchOutCredential.sharedSecretModifiedTime</code> attribute defined at extension <code>b2bpunchout</code>. 
	 * @return the sharedSecretModifiedTime
	 */
	@Accessor(qualifier = "sharedSecretModifiedTime", type = Accessor.Type.GETTER)
	public Date getSharedSecretModifiedTime()
	{
		return getPersistenceContext().getPropertyValue(SHAREDSECRETMODIFIEDTIME);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PunchOutCredential.sharedSecretModifiedTime</code> attribute defined at extension <code>b2bpunchout</code>. 
	 *  
	 * @param value the sharedSecretModifiedTime
	 */
	@Accessor(qualifier = "sharedSecretModifiedTime", type = Accessor.Type.SETTER)
	public void setSharedSecretModifiedTime(final Date value)
	{
		getPersistenceContext().setPropertyValue(SHAREDSECRETMODIFIEDTIME, value);
	}
