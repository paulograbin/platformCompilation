...
public class B2BCustomerModel extends CustomerModel
{
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public B2BCustomerModel(final Collection<CustomerReviewModel> _customerReviews, final String _email, final boolean _loginDisabled, final ItemModel _owner, final BaseSiteModel _site, final String _uid)
	{
		super();
