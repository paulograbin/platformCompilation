 ...
 */
@Schema(name="syncItemStatus", description="DTO that contains the complex synchronization status of the page")
...
@Schema(name="unavailableDependencies") 	
