 ...
 */
@Schema(name="Trigger", description="Representation of a Trigger")
...
@Schema(name="activationTime", description="The time the trigger will be activated", example="2020-12-31T09:00:00+0000") 	
...
@Schema(name="displayTimeTable", description="Description of when the trigger is being activated", example="Every Monday at 00:00:00") 	
