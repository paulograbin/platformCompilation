 ...
 */
@Schema(name="OrderApprovalPermissionType", description="Request body fields required and optional to operate on Order Approval Permission Type data. Typical permission types are: B2BBudgetExceededPermission, B2BOrderThresholdTimespanPermission and B2BOrderThresholdPermission")
...
@Schema(name="code", description="Code of the Order Approval Permission Type", required=true, example="B2BOrderThresholdTimespanPermission") 	
	private String code;
...
@Schema(name="name", description="Name of the Order Approval Permission Type", example="Allowed Order Threshold (per timespan)") 	
	private String name;
