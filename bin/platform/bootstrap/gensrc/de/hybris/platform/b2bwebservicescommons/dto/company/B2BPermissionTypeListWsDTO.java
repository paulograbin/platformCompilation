 ...
 */
@Schema(name="OrderApprovalPermissionTypeList", description="Representation of an Order Approval Permission Type list")
...
@Schema(name="orderApprovalPermissionTypes", description="List of Order Approval Permission Types", required=true) 	
