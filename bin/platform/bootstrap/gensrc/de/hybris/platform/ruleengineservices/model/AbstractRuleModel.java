...
public class AbstractRuleModel extends ItemModel
{
	 ...
	 * @return the endDate - Date on which this promotion stops being available, if not set the promotion will not
	 *                         be available.
	 */
	 ...
	 * @return the startDate - Date on which this promotion becomes available, if not set the promotion will not be
	 *                         available.
	 */
	 ...
	 *  
	 * @param value the endDate - Date on which this promotion stops being available, if not set the promotion will not
	 *                         be available.
	 */
	 ...
	 *  
	 * @param value the startDate - Date on which this promotion becomes available, if not set the promotion will not be
	 *                         available.
	 */
