...
public class RuleGroupModel extends ItemModel
{
	 ...
	 * @return the exclusive - if set to true at most one rule of this group is executed (but potentially multiple
	 *                         times)
	 */
	 ...
	 *  
	 * @param value the exclusive - if set to true at most one rule of this group is executed (but potentially multiple
	 *                         times)
	 */
