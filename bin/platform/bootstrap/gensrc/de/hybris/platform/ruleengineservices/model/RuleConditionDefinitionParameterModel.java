...
public class RuleConditionDefinitionParameterModel extends ItemModel
{
	 ...
	 * @return the filters - The map defines narrowing filtering rules. For every entry: key corresponds to the type
	 *                         field name to narrow for, value corresponds to RuleConditionDefinitionParameter.id to narrow by
	 */
	 ...
	 *  
	 * @param value the filters - The map defines narrowing filtering rules. For every entry: key corresponds to the type
	 *                         field name to narrow for, value corresponds to RuleConditionDefinitionParameter.id to narrow by
	 */
