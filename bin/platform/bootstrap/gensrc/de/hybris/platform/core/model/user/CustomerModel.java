...
public class CustomerModel extends UserModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Customer.site</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String SITE = "site";
	
	/** <i>Generated constant</i> - Attribute key of <code>Customer.undecoratedUid</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String UNDECORATEDUID = "undecoratedUid";
	
	/** <i>Generated constant</i> - Attribute key of <code>Customer.sapGuestUserEmail</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String SAPGUESTUSEREMAIL = "sapGuestUserEmail";
	
	/** <i>Generated constant</i> - Attribute key of <code>Customer.sitePreferences</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String SITEPREFERENCES = "sitePreferences";
	 ...
	 * @param _site initial attribute declared by type <code>Customer</code> at extension <code>commerceservices</code>
	 * @param _uid initial attribute declared by type <code>Principal</code> at extension <code>core</code>
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public CustomerModel(final Collection<CustomerReviewModel> _customerReviews, final boolean _loginDisabled, final ItemModel _owner, final BaseSiteModel _site, final String _uid)
	{
		super();
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.sapGuestUserEmail</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the sapGuestUserEmail - It holds the email address of guest user.
	 */
	@Accessor(qualifier = "sapGuestUserEmail", type = Accessor.Type.GETTER)
	public String getSapGuestUserEmail()
	{
		return getPersistenceContext().getPropertyValue(SAPGUESTUSEREMAIL);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.site</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the site - Attached site
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.sitePreferences</code> attribute defined at extension <code>commerceservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the sitePreferences
	 */
	@Accessor(qualifier = "sitePreferences", type = Accessor.Type.GETTER)
	public List<SitePreferenceModel> getSitePreferences()
	{
		return getPersistenceContext().getPropertyValue(SITEPREFERENCES);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.undecoratedUid</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the undecoratedUid - Attribute is part of uid without the attached site uid.
	 */
	@Accessor(qualifier = "undecoratedUid", type = Accessor.Type.GETTER)
	public String getUndecoratedUid()
	{
		return getPersistenceContext().getPropertyValue(UNDECORATEDUID);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.sapGuestUserEmail</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the sapGuestUserEmail - It holds the email address of guest user.
	 */
	@Accessor(qualifier = "sapGuestUserEmail", type = Accessor.Type.SETTER)
	public void setSapGuestUserEmail(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPGUESTUSEREMAIL, value);
	}
	
	/**
	 * <i>Generated method</i> - Initial setter of <code>Customer.site</code> attribute defined at extension <code>commerceservices</code>. Can only be used at creation of model - before first save.  
	 *  
	 * @param value the site - Attached site
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.sitePreferences</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the sitePreferences
	 */
	@Accessor(qualifier = "sitePreferences", type = Accessor.Type.SETTER)
	public void setSitePreferences(final List<SitePreferenceModel> value)
	{
		getPersistenceContext().setPropertyValue(SITEPREFERENCES, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.undecoratedUid</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the undecoratedUid - Attribute is part of uid without the attached site uid.
	 */
	@Accessor(qualifier = "undecoratedUid", type = Accessor.Type.SETTER)
	public void setUndecoratedUid(final String value)
	{
		getPersistenceContext().setPropertyValue(UNDECORATEDUID, value);
	}
