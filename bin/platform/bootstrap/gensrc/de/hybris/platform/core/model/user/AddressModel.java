...
public class AddressModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Address.city</code> attribute defined at extension <code>chineseaddressservices</code>. */
	public static final String CITY = "city";
	
	/** <i>Generated constant</i> - Attribute key of <code>Address.cityDistrict</code> attribute defined at extension <code>chineseaddressservices</code>. */
	public static final String CITYDISTRICT = "cityDistrict";
	
	/** <i>Generated constant</i> - Attribute key of <code>Address.fullname</code> attribute defined at extension <code>chineseaddressservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.city</code> attribute defined at extension <code>chineseaddressservices</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.cityDistrict</code> attribute defined at extension <code>chineseaddressservices</code>. 
	 * @return the cityDistrict - District of the city.
	 */
	@Accessor(qualifier = "cityDistrict", type = Accessor.Type.GETTER)
	public DistrictModel getCityDistrict()
	{
		return getPersistenceContext().getPropertyValue(CITYDISTRICT);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.fullname</code> attribute defined at extension <code>chineseaddressservices</code>. 
	 * @return the fullname - The full name in delivery address
	 */
	@Accessor(qualifier = "fullname", type = Accessor.Type.GETTER)
	public String getFullname()
	{
		return getPersistenceContext().getPropertyValue(FULLNAME);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Address.city</code> attribute defined at extension <code>chineseaddressservices</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Address.cityDistrict</code> attribute defined at extension <code>chineseaddressservices</code>. 
	 *  
	 * @param value the cityDistrict - District of the city.
	 */
	@Accessor(qualifier = "cityDistrict", type = Accessor.Type.SETTER)
	public void setCityDistrict(final DistrictModel value)
	{
		getPersistenceContext().setPropertyValue(CITYDISTRICT, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Address.fullname</code> attribute defined at extension <code>chineseaddressservices</code>. 
	 *  
	 * @param value the fullname - The full name in delivery address
	 */
	@Accessor(qualifier = "fullname", type = Accessor.Type.SETTER)
	public void setFullname(final String value)
	{
		getPersistenceContext().setPropertyValue(FULLNAME, value);
	}
