...
public class AbstractOrderModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.requestedRetrievalDate</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String REQUESTEDRETRIEVALDATE = "requestedRetrievalDate";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.document</code> attribute defined at extension <code>b2bacceleratorservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the document
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.requestedRetrievalDate</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the requestedRetrievalDate - Date on which the customer requests for order retrieval
	 */
	@Accessor(qualifier = "requestedRetrievalDate", type = Accessor.Type.GETTER)
	public String getRequestedRetrievalDate()
	{
		return getPersistenceContext().getPropertyValue(REQUESTEDRETRIEVALDATE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.document</code> attribute defined at extension <code>b2bacceleratorservices</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.requestedRetrievalDate</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the requestedRetrievalDate - Date on which the customer requests for order retrieval
	 */
	@Accessor(qualifier = "requestedRetrievalDate", type = Accessor.Type.SETTER)
	public void setRequestedRetrievalDate(final String value)
	{
		getPersistenceContext().setPropertyValue(REQUESTEDRETRIEVALDATE, value);
	}
