...
public class AbstractOrderEntryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.arrivalSlots</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String ARRIVALSLOTS = "arrivalSlots";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.arrivalSlots</code> attribute defined at extension <code>commerceservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the arrivalSlots - List of entry arrival slots for this order.
	 */
	@Accessor(qualifier = "arrivalSlots", type = Accessor.Type.GETTER)
	public List<EntryArrivalSlot> getArrivalSlots()
	{
		return getPersistenceContext().getPropertyValue(ARRIVALSLOTS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.arrivalSlots</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the arrivalSlots - List of entry arrival slots for this order.
	 */
	@Accessor(qualifier = "arrivalSlots", type = Accessor.Type.SETTER)
	public void setArrivalSlots(final List<EntryArrivalSlot> value)
	{
		getPersistenceContext().setPropertyValue(ARRIVALSLOTS, value);
	}
