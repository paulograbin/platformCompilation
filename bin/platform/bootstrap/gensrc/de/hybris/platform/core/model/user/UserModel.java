...
public class UserModel extends PrincipalModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>User.initialPassword</code> attribute defined at extension <code>core</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>User.widgetsConfigForBackoffice</code> attribute defined at extension <code>backoffice</code>. */
	public static final String WIDGETSCONFIGFORBACKOFFICE = "widgetsConfigForBackoffice";
	...
	/** <i>Generated constant</i> - Attribute key of <code>User.themeForSmartedit</code> attribute defined at extension <code>smarteditwebservices</code>. */
	public static final String THEMEFORSMARTEDIT = "themeForSmartedit";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>User.themeForSmartedit</code> attribute defined at extension <code>smarteditwebservices</code>. 
	 * @return the themeForSmartedit - the property to set smartedit theme for user
	 */
	@Accessor(qualifier = "themeForSmartedit", type = Accessor.Type.GETTER)
	public ThemeModel getThemeForSmartedit()
	{
		return getPersistenceContext().getPropertyValue(THEMEFORSMARTEDIT);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>User.widgetsConfigForBackoffice</code> attribute defined at extension <code>backoffice</code>. 
	 * @return the widgetsConfigForBackoffice
	 */
	@Accessor(qualifier = "widgetsConfigForBackoffice", type = Accessor.Type.GETTER)
	public MediaModel getWidgetsConfigForBackoffice()
	{
		return getPersistenceContext().getPropertyValue(WIDGETSCONFIGFORBACKOFFICE);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>User.initialPassword</code> attribute defined at extension <code>core</code>. 
	 * @return the initialPassword
	 */
	@Accessor(qualifier = "initialPassword", type = Accessor.Type.GETTER)
	public boolean isInitialPassword()
	{
		return toPrimitive((Boolean)getPersistenceContext().getPropertyValue(INITIALPASSWORD));
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>User.initialPassword</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the initialPassword
	 */
	@Accessor(qualifier = "initialPassword", type = Accessor.Type.SETTER)
	public void setInitialPassword(final boolean value)
	{
		getPersistenceContext().setPropertyValue(INITIALPASSWORD, toObject(value));
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>User.themeForSmartedit</code> attribute defined at extension <code>smarteditwebservices</code>. 
	 *  
	 * @param value the themeForSmartedit - the property to set smartedit theme for user
	 */
	@Accessor(qualifier = "themeForSmartedit", type = Accessor.Type.SETTER)
	public void setThemeForSmartedit(final ThemeModel value)
	{
		getPersistenceContext().setPropertyValue(THEMEFORSMARTEDIT, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>User.widgetsConfigForBackoffice</code> attribute defined at extension <code>backoffice</code>. 
	 *  
	 * @param value the widgetsConfigForBackoffice
	 */
	@Accessor(qualifier = "widgetsConfigForBackoffice", type = Accessor.Type.SETTER)
	public void setWidgetsConfigForBackoffice(final MediaModel value)
	{
		getPersistenceContext().setPropertyValue(WIDGETSCONFIGFORBACKOFFICE, value);
	}
