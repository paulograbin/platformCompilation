...

{
	...
	/** <i>Generated property</i> for <code>AbstractOrderData.requestedRetrievalAt</code> property defined at extension <code>commercefacades</code>. */
	
	private String requestedRetrievalAt;

	/** <i>Generated property</i> for <code>AbstractOrderData.sapGenericPaymentInfo</code> property defined at extension <code>commercefacades</code>. */
	
	private GenericPaymentInfoData sapGenericPaymentInfo;

	/** <i>Generated property</i> for <code>AbstractOrderData.sapBillingAddress</code> property defined at extension <code>commercefacades</code>. */
	
	private AddressData sapBillingAddress;
	...
	public void setSapGenericPaymentInfo(final GenericPaymentInfoData sapGenericPaymentInfo)
	{
		this.sapGenericPaymentInfo = sapGenericPaymentInfo;
	}

	public GenericPaymentInfoData getSapGenericPaymentInfo() 
	{
		return sapGenericPaymentInfo;
	}
	
	public void setSapBillingAddress(final AddressData sapBillingAddress)
	{
		this.sapBillingAddress = sapBillingAddress;
	}

	public AddressData getSapBillingAddress() 
	{
