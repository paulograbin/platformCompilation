...

{
	...
	/** <i>Generated property</i> for <code>CustomerData.sitePreference</code> property defined at extension <code>commercefacades</code>. */
	
	private SitePreferenceData sitePreference;

	/** <i>Generated property</i> for <code>CustomerData.sapGuestUserEmail</code> property defined at extension <code>commercefacades</code>. */
	
	private String sapGuestUserEmail;
	...
	public void setSitePreference(final SitePreferenceData sitePreference)
	{
		this.sitePreference = sitePreference;
	}

	public SitePreferenceData getSitePreference() 
	{
		return sitePreference;
	}
	
	public void setSapGuestUserEmail(final String sapGuestUserEmail)
	{
		this.sapGuestUserEmail = sapGuestUserEmail;
	}

	public String getSapGuestUserEmail() 
	{
		return sapGuestUserEmail;
	}
