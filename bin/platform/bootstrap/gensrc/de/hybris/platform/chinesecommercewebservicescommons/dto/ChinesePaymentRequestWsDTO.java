 ...
 */
@Schema(name="chinesePaymentRequest", description="Chinese payment request")
...
@Schema(name="expiredDate", description="Chinese payment request expired date") 	
