(function () {
    ...
    var eventHandlers = function () {
        $("button.y-btn-primary.integrationbackoffice-modal-button.z-button").on("click", function (e) {
            var canvas = $("canvas");
            if (!canvas.is(":visible")) {
                e.preventDefault();
                return;
            }
            var container = $(".integrationbackoffice-metadata-visualizer.z-networkchart")[0];
            var initialHeight = container.offsetHeight;
            var initialWidth = container.offsetWidth;
            var pxImportant = "px !important;";
            ...
            var newCSS = "width:" + changedWidth + pxImportant + " height:" + changedHeight + pxImportant;
            ...
            $(container).css("cssText", "width:" + initialWidth + pxImportant + "height:" + initialHeight + pxImportant);
            networkChart.redraw();
            networkChart.fit();
