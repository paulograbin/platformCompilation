var f = (t, l, e) => new Promise((r, c) => {
  ...
  }, d = (m) => m.done ? r(m.value) : Promise.resolve(m.value).then(i, h);
  d((e = e.apply(t, l)).next());
});
import { e as s, l as p, a as I, p as u, c as D, U as O, b as P, o as L, s as B, d as Z } from "./parameters-bundle.css.11496d28.mjs";
import { s as F } from "./slot.f280b696.mjs";
import { R as E } from "./ResizeHandler.e19875b3.mjs";
import { r as v, R as z, S as H, T as $, a as R, U as y, V as U } from "./CxQtxSurveyButton.96c49aa8.mjs";
import { g as j } from "./AriaLabelHelper.e3d1fa46.mjs";
import { s as q } from "./parameters-bundle.css.b6a86188.mjs";
import { s as G } from "./parameters-bundle.css.e5697b28.mjs";
var g;
(function(t) {
  t.H1 = "H1", t.H2 = "H2", t.H3 = "H3", t.H4 = "H4", t.H5 = "H5", t.H6 = "H6";
})(g || (g = {}));
const T = g;
var A;
(function(t) {
  t.None = "None", t.Normal = "Normal";
})(A || (A = {}));
const k = A;
function K(t, l, e) {
  return s`${this.h1 ? V.call(this, t, l, e) : void 0}${this.h2 ? W.call(this, t, l, e) : void 0}${this.h3 ? M.call(this, t, l, e) : void 0}${this.h4 ? J.call(this, t, l, e) : void 0}${this.h5 ? Q.call(this, t, l, e) : void 0}${this.h6 ? X.call(this, t, l, e) : void 0}`;
}
function V(t, l, e) {
  return s`<h1 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h1>`;
}
function W(t, l, e) {
  return s`<h2 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h2>`;
}
function M(t, l, e) {
  return s`<h3 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h3>`;
}
function J(t, l, e) {
  return s`<h4 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h4>`;
}
function Q(t, l, e) {
  return s`<h5 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h5>`;
}
function X(t, l, e) {
  return s`<h6 class="ui5-title-root"><span id="${p(this._id)}-inner"><slot></slot></span></h6>`;
}
v("@ui5/webcomponents-theming", "sap_fiori_3", () => f(void 0, null, function* () {
  return I;
}));
v("@ui5/webcomponents", "sap_fiori_3", () => f(void 0, null, function* () {
  return q;
}));
const Y = { packageName: "@ui5/webcomponents", fileName: "themes/Title.css", content: ':host(:not([hidden])){display:block;cursor:text}:host{max-width:100%;color:var(--sapGroup_TitleTextColor);font-size:var(--sapFontHeader2Size);font-family:"72override",var(--sapFontHeaderFamily);text-shadow:var(--sapContent_TextShadow)}.ui5-title-root{display:inline-block;position:relative;font-weight:400;font-size:inherit;box-sizing:border-box;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%;vertical-align:bottom;-webkit-margin-before:0;-webkit-margin-after:0;-webkit-margin-start:0;-webkit-margin-end:0;margin:0;cursor:inherit}:host([wrapping-type=Normal]) .ui5-title-root,:host([wrapping-type=Normal]) ::slotted(*){white-space:pre-line}::slotted(*){font-size:inherit;font-family:inherit;text-shadow:inherit}:host([level=H1]){font-size:var(--sapFontHeader1Size)}:host([level=H2]){font-size:var(--sapFontHeader2Size)}:host([level=H3]){font-size:var(--sapFontHeader3Size)}:host([level=H4]){font-size:var(--sapFontHeader4Size)}:host([level=H5]){font-size:var(--sapFontHeader5Size)}:host([level=H6]){font-size:var(--sapFontHeader6Size)}' };
var N = globalThis && globalThis.__decorate || function(t, l, e, r) {
  var c = arguments.length, i = c < 3 ? l : r === null ? r = Object.getOwnPropertyDescriptor(l, e) : r, h;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    i = Reflect.decorate(t, l, e, r);
  else
    for (var d = t.length - 1; d >= 0; d--)
      (h = t[d]) && (i = (c < 3 ? h(i) : c > 3 ? h(l, e, i) : h(l, e)) || i);
  return c > 3 && i && Object.defineProperty(l, e, i), i;
};
...
N([
  u({ type: k, defaultValue: k.None })
], _.prototype, "wrappingType", void 0);
N([
  u({ type: T, defaultValue: T.H2 })
], _.prototype, "level", void 0);
_ = N([
  D({
    tag: "ui5-title",
    renderer: P,
...
var w;
(function(t) {
  t.Auto = "Auto", t.Base = "Base", t.Spot = "Spot", t.Dialog = "Dialog", t.Scene = "Scene";
})(w || (w = {}));
const S = w;
var x;
(function(t) {
  t.BeforeSearch = "BeforeSearch", t.NoActivities = "NoActivities", t.NoColumnsSet = "NoColumnsSet", t.NoData = "NoData", t.NoMail = "NoMail", t.NoMail_v1 = "NoMail_v1", t.NoEntries = "NoEntries", t.NoNotifications = "NoNotifications", t.NoSavedItems = "NoSavedItems", t.NoSavedItems_v1 = "NoSavedItems_v1", t.NoSearchResults = "NoSearchResults", t.NoTasks = "NoTasks", t.NoTasks_v1 = "NoTasks_v1", t.NoDimensionsSet = "NoDimensionsSet", t.UnableToLoad = "UnableToLoad", t.UnableToLoadImage = "UnableToLoadImage", t.UnableToUpload = "UnableToUpload", t.UploadToCloud = "UploadToCloud", t.AddColumn = "AddColumn", t.AddPeople = "AddPeople", t.AddDimensions = "AddDimensions", t.BalloonSky = "BalloonSky", t.Connection = "Connection", t.EmptyCalendar = "EmptyCalendar", t.EmptyList = "EmptyList", t.EmptyPlanningCalendar = "EmptyPlanningCalendar", t.ErrorScreen = "ErrorScreen", t.FilterTable = "FilterTable", t.GroupTable = "GroupTable", t.NoFilterResults = "NoFilterResults", t.PageNotFound = "PageNotFound", t.ReloadScreen = "ReloadScreen", t.ResizeColumn = "ResizeColumn", t.SearchEarth = "SearchEarth", t.SearchFolder = "SearchFolder", t.SimpleBalloon = "SimpleBalloon", t.SimpleBell = "SimpleBell", t.SimpleCalendar = "SimpleCalendar", t.SimpleCheckMark = "SimpleCheckMark", t.SimpleConnection = "SimpleConnection", t.SimpleEmptyDoc = "SimpleEmptyDoc", t.SimpleEmptyList = "SimpleEmptyList", t.SimpleError = "SimpleError", t.SimpleMagnifier = "SimpleMagnifier", t.SimpleMail = "SimpleMail", t.SimpleNoSavedItems = "SimpleNoSavedItems", t.SimpleNotFoundMagnifier = "SimpleNotFoundMagnifier", t.SimpleReload = "SimpleReload", t.SimpleTask = "SimpleTask", t.SleepingBell = "SleepingBell", t.SortColumn = "SortColumn", t.SuccessBalloon = "SuccessBalloon", t.SuccessCheckMark = "SuccessCheckMark", t.SuccessHighFive = "SuccessHighFive", t.SuccessScreen = "SuccessScreen", t.Survey = "Survey", t.Tent = "Tent", t.UploadCollection = "UploadCollection", t.TntChartArea = "TntChartArea", t.TntChartArea2 = "TntChartArea2", t.TntChartBar = "TntChartBar", t.TntChartBPMNFlow = "TntChartBPMNFlow", t.TntChartBullet = "TntChartBullet", t.TntChartDoughnut = "TntChartDoughnut", t.TntChartFlow = "TntChartFlow", t.TntChartGantt = "TntChartGantt", t.TntChartOrg = "TntChartOrg", t.TntChartPie = "TntChartPie", t.TntCodePlaceholder = "TntCodePlaceholder", t.TntCompany = "TntCompany", t.TntComponents = "TntComponents", t.TntExternalLink = "TntExternalLink", t.TntFaceID = "TntFaceID", t.TntFingerprint = "TntFingerprint", t.TntLock = "TntLock", t.TntMission = "TntMission", t.TntNoApplications = "TntNoApplications", t.TntNoFlows = "TntNoFlows", t.TntNoUsers = "TntNoUsers", t.TntRadar = "TntRadar", t.TntSecrets = "TntSecrets", t.TntServices = "TntServices", t.TntSessionExpired = "TntSessionExpired", t.TntSessionExpiring = "TntSessionExpiring", t.TntSuccess = "TntSuccess", t.TntSuccessfulAuth = "TntSuccessfulAuth", t.TntSystems = "TntSystems", t.TntTeams = "TntTeams", t.TntTools = "TntTools", t.TntUnableToLoad = "TntUnableToLoad", t.TntUnlock = "TntUnlock", t.TntUnsuccessfulAuth = "TntUnsuccessfulAuth", t.TntUser2 = "TntUser2";
})(x || (x = {}));
const C = x, l1 = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="160" height="160" viewBox="0 0 160 160" id="sapIllus-Dialog-BeforeSearch">
...
`, e1 = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-BeforeSearch">
...
`, a1 = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="128" height="128" viewBox="0 0 128 128" id="sapIllus-Spot-BeforeSearch">
...
`, i1 = "BeforeSearch", s1 = "fiori", o1 = H, r1 = $;
z(i1, {
  dialogSvg: l1,
  sceneSvg: e1,
  spotSvg: a1,
...
let o = a = class extends O {
  constructor() {
    super(), this._handleResize = this.handleResize.bind(this), this._lastKnownOffsetWidthForMedia = {}, this._lastKnownMedia = "base";
  }
  static onDefine() {
    return f(this, null, function* () {
      a.i18nBundle = yield R("@ui5/webcomponents-fiori");
    });
  }
  ...
  onBeforeRendering() {
    return f(this, null, function* () {
      ...
      this.hasAttribute("name") && !this.isValidIllustration(e) && console.warn(`The illustration "${e}" does not exist. The default illustration "${C.BeforeSearch}" is loaded instead.`), l === void 0 && (l = yield U(this.name)), this.spotSvg = l.spotSvg, this.dialogSvg = l.dialogSvg, this.sceneSvg = l.sceneSvg, this.illustrationTitle = a.i18nBundle.getText(l.title), this.illustrationSubtitle = a.i18nBundle.getText(l.subtitle), this.size !== S.Auto && this._handleCustomSize();
    });
  }
  onEnterDOM() {
    E.register(this, this._handleResize);
  }
  onExitDOM() {
    E.deregister(this, this._handleResize);
  }
  handleResize() {
    this.size === S.Auto && this._applyMedia();
  }
  _applyMedia() {
    const l = this.offsetWidth;
    let e = "";
    this.offsetWidth <= a.BREAKPOINTS.BASE ? e = a.MEDIA.BASE : this.offsetWidth <= a.BREAKPOINTS.SPOT ? e = a.MEDIA.SPOT : this.offsetWidth <= a.BREAKPOINTS.DIALOG ? e = a.MEDIA.DIALOG : e = a.MEDIA.SCENE;
    const r = this._lastKnownOffsetWidthForMedia[e];
    (!(r && l === r) || this._lastKnownOffsetWidthForMedia[this._lastKnownMedia] === 0) && (this.media = e, this._lastKnownOffsetWidthForMedia[e] = l, this._lastKnownMedia = e);
  }
  _setSVGAccAttrs() {
    const l = this.shadowRoot.querySelector(".ui5-illustrated-message-illustration svg");
    l && (this.ariaLabelText ? l.setAttribute("aria-label", this.ariaLabelText) : l.removeAttribute("aria-label"));
  }
  onAfterRendering() {
  ...
  _handleCustomSize() {
    switch (this.size) {
      case S.Base:
        this.media = a.MEDIA.BASE;
        return;
      case S.Spot:
        this.media = a.MEDIA.SPOT;
        return;
      case S.Dialog:
        this.media = a.MEDIA.DIALOG;
        return;
      default:
        this.media = a.MEDIA.SCENE;
    }
  }
  get ariaLabelText() {
    return j(this);
  ...
  get hasActions() {
    return !!this.actions.length && this.media !== a.MEDIA.BASE;
  }
  isValidIllustration(l) {
    return l in C;
  }
};
n([
  u({ type: C, defaultValue: C.BeforeSearch })
], o.prototype, "name", void 0);
n([
  u({ type: S, defaultValue: S.Auto })
], o.prototype, "size", void 0);
n([
  u()
], o.prototype, "subtitleText", void 0);
n([
  u()
], o.prototype, "titleText", void 0);
n([
  u({ defaultValue: "" })
], o.prototype, "accessibleNameRef", void 0);
n([
  u({ noAttribute: !0 })
], o.prototype, "spotSvg", void 0);
n([
  u({ noAttribute: !0 })
], o.prototype, "sceneSvg", void 0);
n([
  u({ noAttribute: !0 })
], o.prototype, "dialogSvg", void 0);
n([
  u()
], o.prototype, "media", void 0);
n([
  F({ type: HTMLElement })
], o.prototype, "title", void 0);
n([
  F({ type: HTMLElement })
], o.prototype, "subtitle", void 0);
n([
  F({ type: HTMLElement, default: !0 })
...
//# sourceMappingURL=IllustratedMessage.8afc4d6c.mjs.map
