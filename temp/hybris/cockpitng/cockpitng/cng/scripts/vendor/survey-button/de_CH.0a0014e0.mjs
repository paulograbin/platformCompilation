const t = "This file has been derived from Unicode Common Locale Data Repository (CLDR) files (http://cldr.unicode.org). See the copyright and permission notice in the Unicode-Data-Files-LICENSE.txt available at the same location as this file or visit http://www.unicode.org/copyright.html", e = "41.0.0", n = "2022-12-19T09:41:25.319Z", a = "left-to-right", M = {
  ...
  "year-wide": {
    ...
    "relative-type-1": "n\xE4chstes Jahr",
  ...
  "quarter-wide": {
    ...
    "relative-type-1": "n\xE4chstes Quartal",
    "relativeTime-type-future": {
  ...
  "month-wide": {
    ...
    "relative-type-1": "n\xE4chsten Monat",
    "relativeTime-type-future": {
  ...
  "month-short": {
    ...
    "relativeTime-type-past": {
      "relativeTimePattern-count-one": "vor {0} Monat",
      "relativeTimePattern-count-other": "vor {0}\xA0Monaten"
    }
  },
  "month-narrow": {
    displayName: "M",
    ...
    "relativeTime-type-past": {
      "relativeTimePattern-count-one": "vor {0}\xA0Monat",
      "relativeTimePattern-count-other": "vor {0} Monaten"
    }
  },
  "week-wide": {
    ...
    "relative-type-1": "n\xE4chste Woche",
    "relativeTime-type-future": {
  ...
  standard: "\xA4\xA0#,##0.00;\xA4-#,##0.00",
  ...
  "sap-standard": "#,##0.00\xA0\xA4;-#,##0.00\xA4",
  ...
  short: {
    ...
    "consumption-liter-per-kilometer": {
      displayName: "l/km",
      "unitPattern-count-one": "{0}\xA0l/km",
      "unitPattern-count-other": "{0}\xA0l/km"
    },
    ...
    "digital-gigabyte": {
      ...
      "unitPattern-count-one": "{0}\xA0GB",
      "unitPattern-count-other": "{0}\xA0GB"
    },
    "digital-gigabit": {
      displayName: "Gigabit",
      "unitPattern-count-one": "{0}\xA0Gb",
    ...
    "digital-byte": {
      displayName: "Byte",
      "unitPattern-count-one": "{0}\xA0Byte",
      "unitPattern-count-other": "{0} Byte"
    },
    "digital-bit": {
      displayName: "Bit",
      "unitPattern-count-one": "{0}\xA0Bit",
    ...
    "duration-decade": {
      displayName: "Jz.",
      "unitPattern-count-one": "{0}\xA0Jz.",
      "unitPattern-count-other": "{0}\xA0Jz."
    },
    "duration-year": {
      displayName: "J",
    ...
    "energy-foodcalorie": {
      displayName: "kcal",
      "unitPattern-count-one": "{0}\xA0kcal",
      "unitPattern-count-other": "{0}\xA0kcal"
    },
    "energy-kilojoule": {
    ...
    "energy-joule": {
      displayName: "Joule",
      "unitPattern-count-one": "{0}\xA0J",
      "unitPattern-count-other": "{0}\xA0J"
    },
    ...
    "length-light-year": {
      displayName: "Lj",
      "unitPattern-count-one": "{0}\xA0Lj",
      "unitPattern-count-other": "{0}\xA0Lj"
    },
    "length-astronomical-unit": {
      displayName: "AE",
      "unitPattern-count-one": "{0}\xA0AE",
    ...
    "length-nautical-mile": {
      displayName: "sm",
      "unitPattern-count-one": "{0}\xA0sm",
      "unitPattern-count-other": "{0}\xA0sm"
    },
    ...
    "mass-ounce-troy": {
      displayName: "oz.tr.",
      "unitPattern-count-one": "{0}\xA0oz.tr.",
      "unitPattern-count-other": "{0} oz.tr."
    },
    "mass-carat": {
      displayName: "Kt",
      "unitPattern-count-one": "{0}\xA0Kt",
      "unitPattern-count-other": "{0}\xA0Kt"
    },
    "mass-dalton": {
      displayName: "Da",
    ...
    "volume-megaliter": {
      displayName: "Ml",
      "unitPattern-count-one": "{0}\xA0Ml",
      "unitPattern-count-other": "{0}\xA0Ml"
    },
    "volume-hectoliter": {
      displayName: "hl",
      "unitPattern-count-one": "{0}\xA0hl",
      "unitPattern-count-other": "{0}\xA0hl"
    },
    "volume-liter": {
      displayName: "Liter",
      "unitPattern-count-other": "{0} l",
    ...
    "volume-deciliter": {
      displayName: "dl",
      "unitPattern-count-one": "{0}\xA0dl",
      "unitPattern-count-other": "{0}\xA0dl"
    },
    "volume-centiliter": {
      displayName: "cl",
      "unitPattern-count-one": "{0}\xA0cl",
      "unitPattern-count-other": "{0}\xA0cl"
    },
    "volume-milliliter": {
      displayName: "ml",
      "unitPattern-count-one": "{0}\xA0ml",
    ...
    "volume-cup": {
      displayName: "Cups",
      "unitPattern-count-one": "{0}\xA0Cup",
      "unitPattern-count-other": "{0}\xA0Cups"
    },
    "volume-fluid-ounce": {
      displayName: "fl oz",
    ...
    "volume-tablespoon": {
      displayName: "EL",
      "unitPattern-count-one": "{0}\xA0EL",
      "unitPattern-count-other": "{0}\xA0EL"
    },
    "volume-teaspoon": {
      displayName: "TL",
      "unitPattern-count-one": "{0}\xA0TL",
      "unitPattern-count-other": "{0}\xA0TL"
    },
    "volume-barrel": {
      displayName: "bbl",
  ...
  "decimalFormat-short": {
    ...
    "1000000000000-one": "0\xA0Bio'.'",
    "1000000000000-other": "0\xA0Bio'.'",
    "10000000000000-one": "00\xA0Bio'.'",
    "10000000000000-other": "00\xA0Bio'.'",
    "100000000000000-one": "000\xA0Bio'.'",
    "100000000000000-other": "000\xA0Bio'.'"
  },
  scientificFormat: o,
  percentFormat: m,
  currencyFormat: d,
  ...
  "currencyFormat-short": {
    ...
    "1000000000000-one": "0\xA0Bio'.'\xA0\xA4",
    "1000000000000-other": "0\xA0Bio'.'\xA0\xA4",
    "10000000000000-one": "00\xA0Bio'.'\xA0\xA4",
    "10000000000000-other": "00\xA0Bio'.'\xA0\xA4",
    "100000000000000-one": "000\xA0Bio'.'\xA0\xA4",
    "100000000000000-other": "000\xA0Bio'.'\xA0\xA4"
  },
  ...
  "symbols-latn-superscriptingExponent": "\xB7",
...
//# sourceMappingURL=de_CH.0a0014e0.mjs.map
